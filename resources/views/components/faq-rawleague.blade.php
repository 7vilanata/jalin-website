<div>
    ...
    <div>
        <h1
            ...
            FAQ RAW LEAGUE MOBILE LEGEND</h1>
        <!-- Accordion Item 1 -->
            ...
            <div id="content-3" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                <div class="pb-5 text-[14px] md:text-[20px] text-left">
                    ...
                    <ul class="list-disc pl-7">
                        ...
                        <li> 2 Pemain Cadangan
                        </li>
                    </ul>
                    <br>
                    Nama tim wajib sopan, gak mengandung unsur SARA, kekerasan, atau kata-kata kasar.
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#FEFC8B] px-5 rounded-2xl mt-3">
            ...
            <div id="content-5" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                <div class="pb-5 text-[14px] md:text-[20px] text-left">
                    Panitia berhak ubah jadwal atau peraturan kalau dibutuhkan.
                    <br>
                    Dengan klik “Daftar”, lo dianggap udah baca dan setuju semua aturan di atas.
                </div>
            </div>
        </div>
    </div>
    ...
    <div>
        <h1
            class="mt-5 py-5 ultraprint-font inline-block p-3 text-4xl md:text-5xl  rounded-2xl mb-2 text-[#0353FF] font-medium">
            FAQ RAW LEAGUE FUTSAL</h1>
        ...
        <div class="bg-[#FEFC8B] px-5 rounded-2xl mt-3">
            ...
            <div id="content-8" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                <div class="pb-5 text-[14px] md:text-[20px] text-left">
                    Setiap tim futsal terdiri dari:
                    <ul class="list-disc pl-7">
                        <li> 5 Pemain Inti
                        </li>
                        <li> 9 Pemain Cadangan
                        </li>
                    </ul>
                    <br>
                    Nama tim dan jersey harus sopan, gak mengandung kata kasar, rasis, atau SARA.
                </div>
            </div>
        </div>
