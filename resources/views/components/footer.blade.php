<footer class=" text-white text-center ">
    <div class="flex flex-col justify-center z-0 h-[400px] md:h-[600px] lg:h-[700px] 2xl:h-[1200px] rounded-t-[50px] w-full  overflow-x-hidden bg-cover bg-no-repeat bg-bottom  relative"
        style="background-image: url('{{ asset('assets/img/footer-bg.webp') }}');">
        <div class="flex flex-col gap-5 md:gap-20 py-20 justify-self-center justify-between items-center">
            <img class="h-auto w-[30%] md:w-[15%] block z-0" src="{{ asset('assets/img/logo-footer.webp') }}" alt="footer-logo">
        ...
        <div class="text-center flex justify-center gap-20">
            <a href="https://www.instagram.com/generasiraw/" target="_blank"
                class="flex items-center space-x-2 text-white text-[16px] md:text-2xl font-bold">
                <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" width="24"
                ...
                <span>generasiraw</span>
            </a>

            <a href="https://www.tiktok.com/@generasiraw" target="_blank"
                class="flex items-center space-x-2 text-white text-[16px] md:text-2xl font-bold">
                <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24"
                    height="24" focusable="false">
                    <path fill="#ffffff"
