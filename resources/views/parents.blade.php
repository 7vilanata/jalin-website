...
@section('content')
    <section class="relative">
        <section class="lazy-background z-0 md:h-[105vh] h-screen w-full overflow-x-hidden bg-cover relative">
        ...
        <section class=" bg-white rounded-t-[50px] md:rounded-t-[100px] py-20 mt-[-80px] px-10 md:px-50 z-10 relative">
            ...
            <div class="relative w-full pt-[56.25%] rounded-2xl overflow-hidden mt-5 md:mt-25">
                ...
                <iframe class="absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/ZCR7WeE61Yo"
