                            ...
                            <div class="flex justify-center">
                                <div
                                    ...
                                    @foreach ($articles as $article)
                                        <x-card :campaign="$article->campaign_type" :title="$article->title" :image="asset('storage/' . $article->thumbnail)" :alt="$article->thumbnail_alt_text"
                                            :link="route('explore.articles.show', $article->slug)" />
                                    @endforeach
                                </div>
                            </div>
