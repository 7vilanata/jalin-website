                ...
                < Back </a>
                    ...
                    <div class="my-10 text-center">
                        ...
                        <div class="flex justify-center">
                            <div class="flex flex-wrap justify-center lg:justify-start gap-10 md:gap-3 my-10 max-w-screen-xl w-full">
                                            ...
                                            <a href="{{ route('warkop.gallery.show', $gallery->slug) }}"
                                                ...
                                                @if ($gallery->thumbnail)
                                                    <img src="{{ asset('storage/' . $gallery->thumbnail) }}"
                                                        alt="{{ $gallery->title }}" class="w-full h-full object-stretch ">
                                                @endif
                                            </a>
