...
@section('content')
    <div class="relative z-0 mb-[-50px]">
        ...
        <div
            ...
            <!-- Back button -->
            <a href="{{ url('/warkop-raw/schedule') }}" class="text-[#0353FF] text-sm md:text-lg">&lt; Back</a>
            ...
            <div class="my-10 ">
                <div class="flex flex-col text-center  px-5 md:px-20 ">
                    ...
                    <div class="justify-center flex flex-wrap gap-3 md:gap-10 text-[#0353FF] text-[16px]">
                        <span class="flex text-left  items-center gap-1"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            {{ \Carbon\Carbon::parse($schedule->schedule_date)->format('d F Y') }}</span>
                        <span class="flex text-left items-center gap-1"><svg xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="flex justify-center my-10">
                    <img src="{{ asset('storage/' . $schedule->thumbnail) }}" alt="{{ $schedule->title }}"
                ...
                <div class="text-center mt-3 mb-20">
                    <a href="{{ $schedule->loc_link }}" target="_blank">
                        <button type="button"
                            class=" inline-flex items-center gap-3 btn btn-primary rounded-2xl cursor-pointer text-[18px] text-[#FEFC8B] bg-[#FF5632] px-4 py-2">
                            ...
                            <span>{{ $schedule->street_loc }}</span>
                        </button>
                    </a>

                    <iframe class="my-15" width="100%" height="590" frameborder="0" style="border:0"
                        src="https://www.google.com/maps?q={{ $schedule->lat }},{{ $schedule->lng }}&hl=es;z=14&output=embed"
                        allowfullscreen>
                    </iframe>
